...
<div class="pager">
    ...
    <?php if ($previous): ?><a class="pager__item" href="<?= $this->toLink($previous) ?>"><?= $previous ?></a><?php endif ?>
    <a class="pager__item pager__item--current"><?= $current ?></a>
    <?php if ($next): ?><a class="pager__item" href="<?= $this->toLink($next) ?>"><?= $next ?></a><?php endif ?>
    <?php if ($last - $current > 2): ?><span class="pager__spacing">...</span><?php endif ?>
    <?php if ($last - $current > 1): ?><a class="pager__item" href="<?= $this->toLink($last) ?>"><?= $last ?></a><?php endif ?>
</div>